...
class ActorCritic(nn.Module):
    def __init__(self, obs_dim, action_dim):
        ...
        # Actor Network (Continuous Gaussian)
...
class IntrinsicCuriosityModule(nn.Module):
    def __init__(self, state_dim, action_dim, feature_dim=64):
        ...
        # Inverse Model: Predicts action from (phi(s_t), phi(s_{t+1}))
        ...
        # Forward Model: Predicts phi(s_{t+1}) from (phi(s_t), action_t)
...
def train_ppo_icm(
    ...
    vf_coef=0.5, 
    max_grad_norm=0.5,
    icm_scale=0.01,    # Scaled intrinsic coefficient
    beta=0.2,         
    seed=0, 
    device="cpu"
):
    ...
    for update in range(1, num_updates + 1):
        ...
        for step in range(n_steps):
            ...
            # Raw Intrinsic Reward Calculation
        ...
        # Normalize Intrinsic Rewards across the batch buffer to eliminate variance spikes
        ...
        for epoch in range(n_epochs):
            ...
            for start in range(0, n_steps, batch_size):
                ...
                # Update PPO Policy & Value Networks
